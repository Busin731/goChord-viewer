/**
 * A container or Models library. goChord.data is really a "Models" namespace. Please refactor.
 * @class data
 * @namespace goChord
 * @singleton
 */
goChord.data = (function() {
  /**
  ...
  _public.expandedChord = function(name) {
     ...
     * @property name
     * @type string
     * @for goChord.data.expandedChord
     */
    this.name = name;
    /**
